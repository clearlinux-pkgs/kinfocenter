...
Version  : 6.2.5
Release  : 118
URL      : https://download.kde.org/stable/plasma/6.2.5/kinfocenter-6.2.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.5/kinfocenter-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/kinfocenter-6.2.5.tar.xz.sig
...
%setup -q -n kinfocenter-6.2.5
cd %{_builddir}/kinfocenter-6.2.5
pushd ..
cp -a kinfocenter-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736180817
mkdir -p clr-build
pushd clr-build
