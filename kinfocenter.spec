...
Version  : 6.3.4
Release  : 123
URL      : https://download.kde.org/stable/plasma/6.3.4/kinfocenter-6.3.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.4/kinfocenter-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/kinfocenter-6.3.4.tar.xz.sig
...
%setup -q -n kinfocenter-6.3.4
cd %{_builddir}/kinfocenter-6.3.4
pushd ..
cp -a kinfocenter-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744127027
mkdir -p clr-build
pushd clr-build
