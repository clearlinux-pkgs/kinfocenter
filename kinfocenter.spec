...
Source0  : https://download.kde.org/stable/plasma/6.3.0/kinfocenter-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/kinfocenter-6.3.0.tar.xz.sig
...
%setup -q -n kinfocenter-6.3.0
cd %{_builddir}/kinfocenter-6.3.0
pushd ..
cp -a kinfocenter-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739314546
mkdir -p clr-build
pushd clr-build
