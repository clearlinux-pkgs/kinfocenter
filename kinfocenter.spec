...
Version  : 5.17.4
Release  : 31
URL      : https://download.kde.org/stable/plasma/5.17.4/kinfocenter-5.17.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.17.4/kinfocenter-5.17.4.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.4/kinfocenter-5.17.4.tar.xz.sig
...
%prep
%setup -q -n kinfocenter-5.17.4
cd %{_builddir}/kinfocenter-5.17.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575390726
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kinfocenter-5.17.4/COPYING %{buildroot}/usr/share/package-licenses/kinfocenter/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kinfocenter-5.17.4/COPYING.DOC %{buildroot}/usr/share/package-licenses/kinfocenter/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kinfocenter-5.17.4/COPYING.LIB %{buildroot}/usr/share/package-licenses/kinfocenter/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/kinfocenter-5.17.4/Modules/about-distro/COPYING %{buildroot}/usr/share/package-licenses/kinfocenter/842745cb706f8f2126506f544492f7a80dbe29b3
pushd clr-build
%make_install
popd
%find_lang kcminfo
