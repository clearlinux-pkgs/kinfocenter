...
Version  : 6.0.4
Release  : 104
URL      : https://download.kde.org/stable/plasma/6.0.4/kinfocenter-6.0.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.4/kinfocenter-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kinfocenter-6.0.4.tar.xz.sig
...
%setup -q -n kinfocenter-6.0.4
cd %{_builddir}/kinfocenter-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713290311
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/qt6/plugins/plasma/kcms/kinfocenter/kcm_devinfo.so
...
/V3/usr/lib64/qt6/plugins/plasma/kcms/kinfocenter/kcm_nic.so
...
/usr/lib64/qt6/plugins/plasma/kcms/kinfocenter/kcm_devinfo.so
...
/usr/lib64/qt6/plugins/plasma/kcms/kinfocenter/kcm_nic.so
...
%files locales -f kcm_samba.lang -f kcmusb.lang -f kcm_about-distro.lang -f kcm_energyinfo.lang -f kcm_nic.lang -f kcmdevinfo.lang -f kinfocenter.lang
%defattr(-,root,root,-)
