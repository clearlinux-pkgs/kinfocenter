...
Version  : 6.1.1
Release  : 108
URL      : https://download.kde.org/stable/plasma/6.1.1/kinfocenter-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/kinfocenter-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/kinfocenter-6.1.1.tar.xz.sig
...
%setup -q -n kinfocenter-6.1.1
cd %{_builddir}/kinfocenter-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719418150
mkdir -p clr-build
pushd clr-build
