...
Version  : 5.27.10
Release  : 93
URL      : https://download.kde.org/stable/plasma/5.27.10/kinfocenter-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/kinfocenter-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/kinfocenter-5.27.10.tar.xz.sig
...
%prep
%setup -q -n kinfocenter-5.27.10
cd %{_builddir}/kinfocenter-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702968047
mkdir -p clr-build
pushd clr-build
